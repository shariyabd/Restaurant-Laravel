            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <img src="{{asset('frontend')}}/images/news/news-detail-header.jpg" class="img-fluid news-detail-image"
                        ...
                        <div class="col-lg-10 col-10 mx-auto mt-5">
                            ...
                            <p>Phasellus in augue at quam ornare malesuada. Sed magna lorem, dapibus nec lorem sed, pretium
                                vulputate ante. In porttitor sapien urna, eu vulputate arcu pharetra non. Vivamus nec nulla
                                quis leo sodales semper. Quisque sed ultricies tortor. Fusce porta pretium tellus, sit amet
                                vulputate orci.</p>
                            ...
                            <p>Pasta is a type of food typically made from an unleavened dough of wheat flour mixed with
                                ...
                                Rice flour, or legumes such as beans or lentils, are sometimes used in place of wheat flour
                                to yield a different taste</p>

                            <div class="ratio ratio-16x9 my-5">
                                <iframe width="560" height="315"
                                    src="https://www.youtube.com/embed/6vebbDZxoKE?controls=0" title="YouTube video player"
                                    frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                    allowfullscreen></iframe>
                            </div>

                            <p>Crispy Kitchen is free Bootstrap 5 HTML template provided by Tooplate. You are free to use
                                this layout for commercial purposes. You are NOT allowed to redistribute the template ZIP
                                file on any template donwnload website. Please <a href="https://www.tooplate.com/contact"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-12 mx-auto">
                        ...
                        <div class="news-author d-flex flex-wrap align-items-center">
                            <img src="{{asset('frontend')}}/images/author/alexander-hipp-iEEBWgY_6lA-unsplash.jpg"
                        ...
                        <div class="news-author d-flex flex-wrap align-items-center">
                            <img src="{{asset('frontend')}}/images/author/shoeib-abolhassani-ojl7T2Ah93U-unsplash.jpg"
                                class="img-fluid news-author-image" alt="">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <img src="{{asset('frontend')}}/images/charles-deluvio-FdDkfYFHqe4-unsplash.jpg" class="img-fluid newsletter-image"
                            alt="">
                    </div>
                        ...
                        <div class="subscribe-form-wrap">
                            ...
                            <form class="custom-form subscribe-form mt-4" role="form">
                                <input type="email" name="subscribe-email" id="subscribe-email"
                                    pattern="[^ @]*@[^ @]*" class="form-control" placeholder="Your email address"
                                    required="">
